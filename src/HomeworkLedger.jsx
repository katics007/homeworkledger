...
const STRINGS = {
  mr: {
    ...
    vTabLabel: "उभा गणित", mcqTabLabel: "बहुपर्यायी", photoTabLabel: "फोटो / लेखी",
    photoQTypeHint: "प्रश्न आणि उत्तर या दोन्हीसाठी फोटो जोडता येईल.",
  ...
  en: {
    ...
    vTabLabel: "Vertical Math", mcqTabLabel: "MCQ", photoTabLabel: "Photo / Written",
    photoQTypeHint: "You can attach a photo to the question and let students answer with a photo too.",
    ...
    <div className="hl-page">
      ...
      <div className="hl-card">
        ...
        <div className="hl-q-list">
          ...
          {qTab === "photo" && (
            <div className="hl-qtype-add">
              <button className="hl-btn ghost sm" type="button" onClick={addQuestion}><Plus size={14} /> {t("addQuestion")}</button>
            ...
            {hw.questions.map((q) => {
              ...
              return (
                <div className={`hl-result-row ${d.ungraded ? "" : d.correct ? "ok" : "bad"}`} key={q.id}>
                  ...
                  <div style={{ flex: 1 }}>
                    <div className="q">{q.type === "vertical" ? `${toDevanagariDigits(q.a)} ${OP_SYMBOLS[q.op]} ${toDevanagariDigits(q.b)}` : q.text}</div>
                    <div className="a">
          ...
          <div className="hl-result-list">
            {hw.questions.map((q) => {
              ...
              return (
                <div className={`hl-result-row ${d.ungraded ? "" : d.correct ? "ok" : "bad"}`} key={q.id}>
                  {d.ungraded ? <ImageIcon size={14} /> : d.correct ? <Check size={14} /> : <X size={14} />}
                  <span className="q">{q.type === "vertical" ? `${toDevanagariDigits(q.a)} ${OP_SYMBOLS[q.op]} ${toDevanagariDigits(q.b)}` : q.text}</span>
                  <span className="a">
