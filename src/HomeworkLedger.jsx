...
function Style() {
  return (
    <style>{`
      ...
      .hl-page-icon { width: 38px; height: 38px; border-radius: 10px; background: var(--gradient); color: #FFFFFF; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
      ...
      .hl-stat span { display: block; font-family: 'Inter', 'Noto Sans Devanagari', 'Nirmala UI', 'Mangal', sans-serif; font-size: 20px; font-weight: 800; color: var(--board-dark); }
